<template>
  <div class="mt-6">
    <custom-tabs
      v-model="tab"
      :tab-items="[
        { text: 'اطلاعات', icon: 'information' },
        { text: 'ایجاد متن ها', icon: 'text' },
        { text: 'رد درخواست', icon: 'thumb-down' },
      ]"
      grow
    >
          ...
          <v-tab-item>
            <div class="mt-4">
              <div class="row mx-auto">
                ...
                <v-row class="mx-auto">
                  <v-btn
                    class="btn-get-code mx-auto my-auto"
...
export default {
  ...
  methods: {
    ...
    add() {
      for (let i = 0; i < this.count; i++) this.texts.push("");
    },
  },
  watch: {
