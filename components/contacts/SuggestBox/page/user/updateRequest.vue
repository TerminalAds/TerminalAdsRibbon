<template>
  <div class="mt-6">
    <v-text-field v-model="data.title" dense label="عنوان" outlined placeholder="عنوان"/>

    <suggest-text v-model="data.text" :rules="rules.text" label="متن پیامک" placeholder="متن پیامک"/>

    <v-row class="mt-5">
      <v-btn :loading="loading" class="btn-get-code" style="letter-spacing: normal" @click="submit">
        ویرایش متن
      </v-btn>
    </v-row>
