<template>
  <v-card class="pt-4" flat>
    <custom-tabs
      v-model="tabs"
      :tab-items="[
        { text: i18n.t('TABS.LIST'), icon: 'format-list-bulleted' },
        { text: i18n.t('TABS.ADD'), icon: 'plus' },
      ]"
      grow
    >
                ...
                <v-row no-gutters>
                  <v-col class="pa-2" cols="12" lg="1" md="2">
                    <v-select
                      ...
                      dense
                      hide-details
                      :label="i18n.t('TABLE_CONTROLS.COUNT')"
                      outlined
                    />
                  </v-col>
                  <v-col class="pa-2" cols="12" lg="4" md="6">
                    <v-text-field
                      ...
                      dense
                      hide-details
                      :label="i18n.t('TABLE_CONTROLS.SEARCH')"
                      outlined
                    />
                  </v-col>
                </v-row>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      {
        value: "id",
        text: i18n.t("TABLE_HEADERS.ID"),
        align: "center",
        sortable: false,
      },
      {
        value: "name",
        text: i18n.t("TABLE_HEADERS.GROUP_NAME"),
        align: "center",
        sortable: false,
      },
      {
        value: "parent_id",
        text: i18n.t("TABLE_HEADERS.PARENT"),
        align: "center",
        sortable: false,
      },
      {
  ...
  methods: {
    fetchGroups(params = this.tableProps) {
      ...
      this.$payamakAxios
        .get("phoneTag/groups/get", { params })
