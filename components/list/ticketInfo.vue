<template>
  <v-row class="fill-height" no-gutters>
    ...
    <v-col v-else class="pa-2" cols="12" lg="12" md="6">
      <div class="card card-custom card-body fill-height pt-4 px-6">
        <v-row no-gutters>
          <v-col cols="7">
            <h6
              class="text-dark font-weight-bolder line-height-lg"
              style="font-size: 11pt"
            >
              {{ i18n.t("ticker.register") }}
            </h6>
            <p class="mt-5">
              <a
                class="text-dark"
              ...
              >
                ...
                <br />
                <span class="btn btn-info py-1 mt-21">{{
                  i18n.t("ticker.register")
                }}</span>
              </a>
            </p>
    ...
    <v-col class="pa-2" cols="12" lg="6" md="3" sm="6">
      ...
      >
        <div class="card-body pe-1">
          <div
            class="text-dark font-weight-bolder font-size-h2 mt-20"
            v-text="price(announcement)"
          />
          <p class="black--text">
            {{ DConfigs.dashboardConfig.announcement.text }}
          </p>
        </div>
      </a>
    </v-col>
    ...
    <v-col class="pa-2" cols="12" lg="6" md="3" sm="6">
      <a
        :href="DConfigs.dashboardConfig.numbers.url"
      ...
      >
        <div class="card-body pe-1">
          <div
            class="text-dark font-weight-bolder font-size-h2 mt-20"
            v-text="price(numbers)"
          />
          <p
            class="black--text"
            v-text="DConfigs.dashboardConfig.numbers.text"
          />
        </div>
      </a>
    </v-col>
