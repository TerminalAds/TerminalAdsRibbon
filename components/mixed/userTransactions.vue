    ...
    <v-row no-gutters>
        <v-col cols="12" sm="7" lg="12" class="pa-2">
            <div class="card card-custom card-stretch"
                 :style="$vuetify.breakpoint.lgAndUp ? 'min-height: 24.5rem;max-height: 24.5rem;': ''">
                <div class="card-body d-flex flex-column px-5">
                    <template>
                        <div>
                            <h4>آخرین تراکنش ها</h4>
                            <span>موجودی شما:</span>
                            <span class="float-left">{{ persianNum(currency(balance)) }} ﷼ </span>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md mt-5">
                            <b-btn class="btn btn-link-info mt-5" @click="$store.dispatch('wallet/toggleOpen')">
        ...
        <v-col cols="12" sm="5" lg="12" class="pa-2">
            <div class="card card-custom card-stretch">
                ...
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body d-flex flex-column px-0 pb-3">
                    <div class="flex-grow-1 card-spacer-x">
                        <div class="row mb-4">
                            <div class="d-flex col-md-4">
                                <a v-b-tooltip.hover="'اینستاگرام ترمینال ادز'"
                                   href="https://www.instagram.com/terminal._.ads/">
                                ...
                                <a v-b-tooltip.hover="'واتساپ ترمینال ادز'" href="#">
                                    <img class="img-fluid " width="50px"
                            ...
                            <div class="col-md float-right text-left" style="margin-right:5rem">
                                <img src="../../assets/img/social-media-marketing-landing.jpg"
                                     alt="" class="img-fluid" style="width: 100%;max-width: 180px;object-fit: contain">
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        fetch() {
            this.loading = true;
            this.$DashboardAxios.get('/api/core/transactions')
                .then(({data}) => {
                    this.loading = false;
    ...
    computed: {
        ...
        balance() {
            let balance = this.$store.getters['wallet/wallet'];
...
<style>
.myClass {
    background-image: url('https://static.vecteezy.com/system/resources/previews/006/405/811/non_2x/card-payment-via-pos-machine-payment-method-flat-illustration-vector.jpg'), linear-gradient(0, rgba(0, 0, 0, 0.56), rgba(0, 0, 0, .56)) !important;
