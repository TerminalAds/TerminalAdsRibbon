    ...
    Vue.mixin({
      ...
      methods: {
        ...
        ribbon_can(permission) {
          ...
          return (
            abilities.indexOf(permission + ":active") >= 0 ||
            abilities.indexOf(permission + ":show") >= 0
          );
        },
        persianNum(input) {
          if (i18n.locale !== "fa") return input.toLocaleString();
        ...
        hasPhonebookPermission(value, target = null) {
          ...
          else p = options.store.getters["phonebook/phonebookPermissions"];
        ...
        copyLink(str, isLink = true, message = null) {
          ...
          if (!link.startsWith("http") && isLink) link = "https://" + link;
